 ...
 // --- Abrir galería, comprimir y subir imagen al Bucket de Supabase ---
  async function pickAndUploadImage() {
    ...
    const result = await ImagePicker.launchImageLibraryAsync({
      ...
      allowsEditing: true,
      aspect: [1, 1],
      quality: 1, // Dejamos que el ImageManipulator controle la calidad final
    });
    ...
    try {
      ...
      // ==========================================
      // COMPRIMIR Y REDIMENSIONAR AVATAR ANTES DE SUBIR
      // ==========================================
      const manipResult = await ImageManipulator.manipulateAsync(
        imageUri,
        [{ resize: { width: 500 } }], // Las fotos de perfil no necesitan ser gigantes (500px de ancho es ideal)
        { compress: 0.2, format: ImageManipulator.SaveFormat.JPEG } // Compresión máxima (20% de calidad o ajusta a 0.7 si prefieres más nitidez)
      );
