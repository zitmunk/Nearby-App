...
export const Colors = {
  ...
  textSecondary: '#f3f4f6',    // Texto secundario claro
  textMuted: '#78716c',        // Texto apagado o placeholders
  primary: '#facc15',          // Color principal de botones (Amarillo)
  primaryLight: '#facc15',
  accentRed: '#dc2626',        // Rojo para tus mensajes enviados
  accentYellow: '#facc15',     // Amarillo para bordes o detalles
};